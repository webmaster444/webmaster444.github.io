...
d3.gantt = function() {
    ...
    var initTimeDomain = function(tasks) {
        // if (timeDomainMode === FIT_TIME_DOMAIN_MODE) {
            ...
            timeDomainEnd = tasks[tasks.length - 1][3];
            timeDomainStart = tasks[0][3];

            console.log('min:'+timeDomainStart);
            console.log('max:'+timeDomainEnd);
    };
